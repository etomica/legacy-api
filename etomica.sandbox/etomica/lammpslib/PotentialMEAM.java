...
public class PotentialMEAM extends PotentialN implements PotentialSoft {
	...
	public PotentialMEAM(ISpace space) {
	 ...
	 public void setParameters(IAtomType atomTypeLeaf, ParameterSetMEAM p) {
	 ...
	 public void setParametersIMC(IAtomType atomTypeLeaf, ParameterSetMEAM p) {
    ...
    private final Vector3D giEu = (Vector3D)space.makeVector();
    ...
    private final Vector3D giEuB = (Vector3D)space.makeVector();
