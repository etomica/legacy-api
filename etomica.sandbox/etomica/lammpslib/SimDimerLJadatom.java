...
import etomica.dimer.SimDimerLJadatom;
<<<<<<< SimDimerLJadatom.java
...
>>>>>>> 1.41
    ...
    public void enableDimerSearch(String fileName, long maxSteps, boolean orthoSearch, boolean fine){
        ...
        integratorDimer = new IntegratorDimerRT(this, maxSteps, potentialMaster, new ISpecies[]{movable}, space);
    ...
    public void enableMinimumSearch(String fileName, boolean normalDir){
        ...
        integratorDimerMin = new IntegratorDimerMin(this, 0, potentialMaster, new ISpecies[]{movable}, space);
