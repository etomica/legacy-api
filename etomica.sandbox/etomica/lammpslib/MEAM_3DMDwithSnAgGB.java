...
public class MEAM_3DMDwithSnAgGB extends Simulation {
    ...
    private static final String APP_NAME = "MEAM 3DMD w/SnAgGB";
...
//        cuA = new SpeciesSpheresMono(space, Copper.INSTANCE);
        agFixedB = new SpeciesSpheresMono(space, SnF);
        agFixedB.setIsDynamic(true);
...
//		potentialN.setParameters(cuA.getLeafType(), ParameterSetMEAM.Cu);
		potentialN.setParameters(agFixedB.getLeafType(), ParameterSetMEAM.Ag);
