...
>>>>>>> 1.18
        ...
        lammpsSim = LammpsInterface.makeLammpsSim("/usr/users/msellers/simulation/lammps-couple/in.sn");
...
<<<<<<< SimKMCLJadatom.java
            ((IAtomPositioned)newMolecule.getChildList().getAtom(0)).getPosition().E(((IAtomPositioned)((IMolecule)movableList.getMolecule(i)).getChildList().getAtom(0)).getPosition());
...
>>>>>>> 1.18
    ...
    public void integratorKMC(){
        integratorKMC = new IntegratorKMC(this, lammpsSim, potentialMaster, 0.6, this.getRandom(), new ISpecies[]{movable}, this.getSpace());
    ...
    public void integratorKMCCluster(double temp, int steps, int totalSearch){
        integratorKMCCluster = new IntegratorKMCCluster(this, lammpsSim, potentialMaster, temp, totalSearch, this.getRandom(), new ISpecies[]{movable}, this.getSpace());
...
public void enableDimerSearch(String fileName, long maxSteps){
        ...
        integratorDimer = new IntegratorDimerRT(this, lammpsSim, potentialMaster, new ISpecies[]{movable}, space);
