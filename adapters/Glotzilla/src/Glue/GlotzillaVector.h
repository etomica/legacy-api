...
#ifndef GLOTZ_VECTOR_WRAPPER_H
#define GLOTZ_VECTOR_WRAPPER_H
...
namespace glotzwrappers
{
    ...
    /**
      * A GlotzillaVector is a vector that holds a Glotzilla native vector
      * (glotzmath::glotz_vec).  The native vector this class holds is mutable
      * and so, when this vector is modified, the native vector is changed.
      *
      * GlotzillaVector is a virtual class and is used as a superclass for
      * other vector classes.
      */
    class GlotzillaVector : public virtual IAPIVectorMutable {
        ...
        public:
           ...
           /**
             ...
             *         (glotzmath::glotz_vec) that this instance is holding.
             */
            glotzmath::glotz_vec *getGlotzVector();

        protected:
            int D;
            glotzmath::glotz_vec (*glotzVec);
